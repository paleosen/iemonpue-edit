    ...
    if submit_button:
        ...
        with st.spinner("Sedang memproses data..."):
            ...
            try:
                ...
                target_cols = ['No','satker_paket_uraian','unor','Tahun','target_vol','target_satuan','jenispekerjaan','satker','lokasi','jenis_pengadaan','metode_pemilihan','pagu_efektif','realisasi','progres_keu','progres_fisik']
